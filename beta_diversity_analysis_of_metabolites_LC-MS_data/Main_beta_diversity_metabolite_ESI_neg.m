function Main_beta_diversity_metabolite_ESI_neg
% This function performs PCA on the normalized LC-MS data of ESI Negative
%
%
clc;clear;close all
rng default
...
tbl = readtable('../data/neg_normalized.txt','delimiter','\t');

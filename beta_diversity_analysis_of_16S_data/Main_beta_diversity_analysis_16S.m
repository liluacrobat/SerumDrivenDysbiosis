function Main_beta_diversity_analysis_16S
% Run beta-diversity PCoA and correlation biplot
%
%   This script loads precomputed 16S data, computes Bray–Curtis distances,
...
% ---------------------------
type1 = catLabel(meta,7);  % grouping by serum
type2 = catLabel(meta,6);  % grouping by serum distinguishing initial and shift
